...
export function Hero() {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-stretch justify-center overflow-hidden">
      ...
      {/* Ajustes de posicion vertical: cambia pt-20 / pb-12 / md:pb-16 para subir o bajar todo el contenido */}
      <div
      ...
      >
        ...
        {/* Ajuste del bloque inferior: usa mt-auto para fijar al fondo */}
        <div className="mt-auto">
          ...
          <div className="flex justify-center gap-4 md:gap-20 mt-20 mx-auto">
            <div className="text-center">
              <div className="text-2xl md:text-5xl font-bold text-white mb-2">100%</div>
              <div className="text-sm text-gray-300 uppercase tracking-wide">{t("electrico")}</div>
            </div>
            <div className="text-center">
              <div className="text-2xl md:text-5xl font-bold text-white mb-2">40+</div>
