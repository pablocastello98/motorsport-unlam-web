  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img
          src="/images/home/hero/motorsport-unlam-formula-sae-argentina-top-race-autodromo-galvez-buenos-aires-2025-11.webp"
      ...
      <div
        className={`relative z-10 container mx-auto px-4 py-20 text-center transition-all duration-1000 ${
