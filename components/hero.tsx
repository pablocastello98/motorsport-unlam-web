  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-stretch justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img
          src="/images/home/hero/motorsport-unlam-formula-sae-argentina-foto-grupal.webp"
      ...
      >
        ...
        <div className="mt-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button
              size="lg"
              className="group bg-white hover:bg-gray-100 text-black text-lg px-8 py-6 h-auto transition-all duration-300 hover:scale-105 shadow-xl"
              onClick={() => document.getElementById("about")?.scrollIntoView({ behavior: "smooth" })}
            >
              <span>{t("conoceProyecto")}</span>
              <ArrowRight className="ml-2 w-5 h-5 transition-transform duration-300 group-hover:translate-x-1" />
            </Button>
            <Button
              size="lg"
              variant="outline"
              className="border-white text-white hover:bg-white hover:text-black text-lg px-8 py-6 h-auto bg-transparent transition-all duration-300 hover:scale-105 shadow-xl"
          ...
          <div className="flex justify-center gap-4 md:gap-20 mt-20 mx-auto">
            <div className="text-center">
              <div className="text-xl md:text-5xl font-bold text-white mb-2">2027</div>
              <div className="text-sm text-gray-300 uppercase tracking-wide">{t("interlagos")}</div>
            </div>
            <div className="text-center">
              <div className="text-xl md:text-5xl font-bold text-white mb-2">100%</div>
              <div className="text-sm text-gray-300 uppercase tracking-wide">{t("electrico")}</div>
            </div>
            <div className="text-center">
              <div className="text-xl md:text-5xl font-bold text-white mb-2">40+</div>
